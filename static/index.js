...
var ComponentBaseFactory = function ComponentBaseFactory(config) {
    var Component = $('<div class="ComponentBase"/>');
    var Id = (Math.random() + '').replace('.', '_');
    Component.attr('id', Id);
    config.name && Component.addClass(config.name); //如果config.name有，看后面的最后返回后面的结果
    config.width && Component.css('width', config.width / 2); //因为移动端屏幕小，所以都讲他们初以2
...
exports.default = ComponentBaseFactory;
...
var _ComponentPolyLine = __webpack_require__(9);

var _ComponentPolyLine2 = _interopRequireDefault(_ComponentPolyLine);

var _ComponentPie = __webpack_require__(8);

var _ComponentPie2 = _interopRequireDefault(_ComponentPie);

var _ComponentBar = __webpack_require__(7);
...
var ManageObj = {
    ...
    addComponent: function addComponent() {
        var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { type: 'Bar' };
        //创建组件，在基础组件上有高级组件
        var Component = null;
        switch (config.type) {
            case "Poly":
                Component = (0, _ComponentPolyLine2.default)(config);
                break;
            case "Pie":
    ...
    load: function load() {
        ...
        this.oContainer.fullpage({
            //分页要调用的方法，必须和section一起用，才能产生分页效果
...
exports.default = ManageObj; //es6写法的导出
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var ComponentPieFactory = function ComponentPieFactory(config) {
    var Component = (0, _ComponentBase2.default)(config);
    Component.addClass('ComponentPie'); //画饼图
    ...
    ctx.fill();
    var oDataCvs = $('<canvas/>').get(0);
    var _ref3 = [w, h];
    oDataCvs.width = _ref3[0];
    oDataCvs.height = _ref3[1];
    ...
    data.forEach(function (ele, index) {
        //做一个循环 终止角度 起始角度 + 0.3 * 满角
        eAngle = sAngle + ele[1] * aAngle; //eAngle是终止的角度，sAngle是起始的角度
        ctx.beginPath();
        ctx.fillStyle = ele[2];
        ctx.moveTo(r, r);
        ...
        if (trueAngle >= 1.5 * Math.PI && trueAngle <= aAngle || trueAngle >= 3 * Math.PI && trueAngle < 3.5 * Math.PI) {
...
var ComponentPolyLineFactory = function ComponentPolyLineFactory(config) {
    //折线图
    var Component = (0, _ComponentBase2.default)(config);
    Component.addClass('ComponentPolyLine');
    var oCanvas = $('<canvas/>').get(0); //创建一个canvas画布
    console.log(oCanvas);
    ...
    for (var _i = 0; _i < config.data.length + 2; _i++) {
        // 垂直线
        var x = oCanvasW / (config.data.length + 1) * _i;
        ctx.moveTo(x, 0);
    ...
    function draw(per) {
        ...
        ctxTop.beginPath();
        var colW = config.width / (config.data.length + 1);
        data.forEach(function (ele, index) {
            // 画圆
            var x = colW * (index + 1);
        ...
        ctxTop.stroke();
        ctxTop.moveTo(colW, config.height * (1 - config.data[0][1] * per)); // 连线
        data.forEach(function (ele, index) {
            var x1 = colW * (index + 1);
            var y1 = config.height * (1 - ele[1] * per);
            ctxTop.lineTo(x1, y1);
...
exports.default = ComponentPolyLineFactory;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
// module
exports.push([module.i, ".ComponentPie canvas {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n}\n.ComponentPie .text {\n  opacity: 0;\n  transition: all 1s ease-in 1.2s;\n}\n.loadComponent .text {\n  opacity: 1;\n}\n.leaveComponent .text {\n  opacity: 0;\n}\n", ""]);
...
// module
exports.push([module.i, ".ComponentPolyLine canvas {\n  position: absolute;\n  width: 100%;\n  height: 100%;\n}\n.ComponentPolyLine .text {\n  transition: all 1s ease-in-out 1.2s;\n  opacity: 0;\n}\n.loadComponent .text {\n  opacity: 1;\n}\n.leaveComponent .text {\n  opacity: 0;\n}\n", ""]);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/lib/loader.js!./ComponentBar.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/lib/loader.js!./ComponentBar.less");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/lib/loader.js!./ComponentBase.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/lib/loader.js!./ComponentBase.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/lib/loader.js!./ComponentPie.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/lib/loader.js!./ComponentPie.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/lib/loader.js!./ComponentPolyLine.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/lib/loader.js!./ComponentPolyLine.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/lib/loader.js!./pageComponent.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/lib/loader.js!./pageComponent.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = __webpack_require__.p + "c32f0837294f8364f3b5c7396bb21cb2.jpg";

/***/ }),
/* 26 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "58db4c6781383f884c4a04f58bd53e23.jpg";
...
_ManagePageComponent2.default.init('wrapper').addPage('index').addComponent({
    width: 428,
    height: 92,
    center: true,
    css: {
    ...
    data: [['Css2', 0.05, 'blue'], ['Javascript', 0.3, 'orange'], ['ajax\jsonp', 0.05, 'pink'], ['Jquery', 0.1, 'red'], ['Css3', 0.15, 'yellow'], ['Es6', 0.1, 'green'], ['H5', 0.15, 'purple'], ['React', 0.1, 'red']],
    delay: 1000
}).addPage().addComponent({
    width: 500,
    height: 124,
    ...
    data: [['Js', 0.4, 'blue'], ['jQ', 0.1, 'orange'], ['H5', 0.2, 'red'], ['Css3', 0.15, 'green'], ['Es6', 0.05, 'purple'], ['React', 0.1, 'red']],
    delay: 1000
}).addPage().addComponent({
    width: 500,
    height: 126,
    ...
    data: [['Css2', 0.05, 'blue'], ['Js', 0.3, 'orange'], ['ajax\jsonp', 0.05, 'pink'], ['Jquery', 0.1, 'red'], ['Css3', 0.15, 'yellow'], ['Es6', 0.1, 'green'], ['H5', 0.15, 'red'], ['React', 0.1, 'purple']],
    delay: 1000
}).addPage().addComponent({
    name: 'back',
    width: 48,
    ...
    event: {
        click: function click() {
            console.log(_ManagePageComponent2.default.oContainer);
            console.log(_ManagePageComponent2.default.oContainer.fullpage.moveTo);
            _ManagePageComponent2.default.oContainer.fullpage.moveTo(1);
        }
    },
    delay: 200
}).addComponent({
